...
- A-Ws:
  - MH-9464 (Miserere)
  - MH-9465 (Miserere)
  - MH-9466 (Stabat mater)
  - MH-9467 (Stabat mater)
  - MH-10575 (Stabat mater)
  - Teilnachlass Alexander Weinmann ([Salve Regina, Sonata a tre, Stabat Mater](https://permalink.obvsg.at/wbr/AC16444621))
  - Notenarchiv der Internationalen Gesellschaft für Neue Musik, Sektion Österreich ([Partita a tre, Sonata e-moll](https://permalink.obvsg.at/wbr/AC15894371))
- CZ-K:
...
- CZ-Pn:
  ...
  - XXVIII E 162 (mass)
  - XXVIII E 163 (mass)
- a mass and a litany in the inventory of Nagyszombat [@Kim1998, p. 345f]
- prior editions (see @Bartos2018 [p. 89ff])
...
Later changes in the RISM database were manually added to the catalogue (2025-02-09: 331 entries for “Tůma, František Ignác” and 4 entries for “Tůma”). Pages for all groups of works were generated automatically from `catalogue_overview.csv` and `catalogue_works.csv`. If manually curated incipits were unavailable for a work, the first incipit of the first source with a RISM entry was included. Data from the [RISM Catalogue](https://opac.rism.info) (e.g., Plaine & Easie Code for incipits) by the *Répertoire International des Sources Musicales* is licensed under a Creative Commons Attribution CC-BY 3.0 Unported License.
