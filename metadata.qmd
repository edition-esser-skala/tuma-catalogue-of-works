...
- **location(s)**:
  - *library siglum*
  - *shelfmark* (a colon followed by a number indicates that a shelfmark has been split manually, since it comprises several works)
  - link to *digitized version* (if available)
  - link to *catalogue entry* (if available)
- **RISM identifier**
