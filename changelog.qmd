...
- incipits and metadata for TumW C.3.25/26/28, D.1.3, D.2.16/18/S2, E.5.S3, and G.S1
- reference @Bardos1984
- a table of recordings


### Changed

- technically equivalent to WerW v0.22.0
...
- work: TumW G.L14
- incipits and metadata for TumW C.5.1–27, D.2.1, D.3.2, E.1.5, E.2.4, E.5.S2, F.6, G.11, I.11, J.19, and K.1/4/10/12/16/19
- sources SK-BRj HJ 29, HJ 159, and HJ 350
- reference: @ZinkovyInv
- acknowledgements for Das Lehotská
- location numbers of A-Wgm sources where available


### Changed

- Bar numbers in instrumental works now only count unique bars.
- technically equivalent to WerW v0.21.0
...
- work: TumW C.4.9
- incipits and metadata: TumW A.25, C.3.24, C.5.28, C.6.1, D.1.2, D.2.17, and D.3.5
- sources:
  - A-KN: 1262 and 1348
  - A-ST: Mus.ms. 1349
- references: @Anderl2014, @BlizkoviceInv, @BrnoSvJakubaInv, @Lang1978, @Lashofer1983, @Prominczel2024, and @Ratolistkova2018
- acknowledgements: Anderl, Petermayr
- scribe Copyist Ottobeuren 1
- writing samples for P. Maurus Brunnmayr, P. Marianus Prazner, and P. Josephus Unterberger, and Copyist Ottobeuren 1
- TumW D.1.3: info that H-Sp source has been lost


### Changed

- renumbered TumW E.4.1/2/3 to S1/1/2
- technically equivalent to WerW v0.20.0
...
- works: TumW D.2.21 and K.20
- incipits and metadata: TumW C.2.8, C.3.22/27, C.4.1/7/8, D.1.1, D.2.3/21, D.3.4, E.1.4, E.2.1, E.5.S1, F.S1, G.13, I.19, J.1, and K.3/20
- sources:
  - A-Wst: ZPM-823:1 to 4
  - A-Wgm: XI 74966 and XI 75073
- reference @WinklerKlement2013
  

### Changed

- The following works have been merged, reclassified, or renumbered:
  - group D.2: 15 merged to D.1.1; 16–21 → 15–20, 22 → S2
  - group D.4: L1 merged to D.1.1; L2 → L1
  - group E.5: 9 → S3
  - group F: 4 → S1, 5–8 → 4–7
  - group G: 10 → 7, 15 → 8, 16 → 9, 8 → 10, 9 → 11, 7 → 12, 11 → 13, 20 → 14, 23 → 15, 24 → 16, 14 → 17, 17 → 18, 18 → 19, 12 → 20, 19 → 21, 21 → 22, 22 → 23, 13 → S1
- Manual subdivision of shelfmarks is now indicated via a colon. Concomitantly, all shelfmarks are now unique.
- updated sources A-Wgm I 1648, I 1718, I 2767, I 7364, I 17564, I 17565, and I 27552
- technically equivalent to WerW v0.19.0
...
- works: TumW A.L16/S11/S12, C.3.L11, D.1.S2, E.5.S1/S2, and G.23/24/L12/L13
- incipits and metadata: TumW A.24 and H.4
- sources:
  - A-HE: VIII a 2
  - CZ-Bm: A 1854, A 1855, A 2250, A 3437, A 13937, A 17575, A 20181–7, A 32609/1–5, and A 42890
  - CZ-K: 125 and 126
  - CZ-Pn: XXVIII E 159 to 163
  - D-OB: MO 372
  - H-Bn: Ms. mus. IV. 1.907
  - PL-KŁwnm: M-109
- references:
  - general: @Deutsch1994, @Hofer1947, @Hug2007, @Petermayr2020
  - inventories: @EisenstadtInv, @Freemanova1998, @Lukes2021, @OsekInv, @Pielech2019
  - editions: @Haberl1882, @Hofer1952, @Marak1919, @Schmid1903a
- acknowledgements: A-M, CZ-K, and Manas
- indication of the license on the homepage
- index of works by library
- details on Eisenstadt inventory
- a colophon with infos on R packages

### Changed

- revised information on spurious and lost works for which detailed metadata will not be created
- updated metadata for TumW G.20, since an accessible source was discovered
- revised A-H and A-KN inventories, added all references to them
- References are now classified as general references or inventories. Accordingly, the appendix “Concordances” now only describes prior catalogues of Werner's works, while all inventories are now in the appendix with the same name. Several inventory entries for a single work are now correctly represented.
- technically equivalent to WerW v0.18.0

### Removed

- unnecessary lost manuscripts (notably, A-H and A-KN)
...
- incipits and metadata: TumW C.3.23, C.4.6, D.2.4/13/16/21, D.4.2, E.1.3, E.5.8, G.19–22, H.3, I.22, J.18, and L.4
- sources: A-Ee N1447 and N1448
- acknowledgements for A-Ee, CZ-Bm, CZ-Pak, CZ-Pn, and Ellensohn
- a list of scribes, including writing samples for Copyist E, Leysser, Ristl, and Tůma
- references: @Eybl2022 and @Unger2025
- missing citations for @Eybl1996, @Vogg1951, and @Peschek1956


### Changed

- merged TumW G.S1 to D.1.1
- renumbered TumW L.1 to L.L1 and L.2–4 to L.1–3
- technically equivalent to WerW v0.17.0


### Fixed

- In dark mode, incipits, tables, inline code, time signatures, and ees links are now displayed correctly.
- In all MEI metadata, the language of titles “Kyrie/Christe [eleison]” is now Greek.
- In all MEI metadata, ISO dates that only comprise are year now only contain this year (previously: 1st January of this year, e.g., 1750-01-01).
- References now have separate publisher and location fields.
...
- incipits and metadata: TumW C.3.19, C.4.4, D.2.2, D.4.1, E.2.2, E.4.3, E.5.1, G.1, I.21, J.16, and L.2
- sources: US-Wc ML96 S38 case (1-7)
- reference: @Fukac1959
- edition: @Michl2021
- acknowledgements for A-GE, A-Wdtö, and US-Wc
- concordances for historic [@BrtniceInv; @EsterhazyInv1812; @MelkInv; @RajhradInvA; @RajhradInvB] and modern inventories [@Bardos1980; @Stefan1985]


### Changed

- technically equivalent to WerW v0.16.0
...
- editions: @Fuerlinger1997 and @Schmid1900b
- work numbers from @MacIntyre1984
...
- references @Blume1992, @Horvath1971, @Kellner1956, @KlosterneuburgInvC, @Kim1998, and @Pfiffig1975
...
- references: @Armstrong1993, @Armstrong2004, @Bardos1980, @Czernin1995, @EsterhazyInv1812, @Fischer1912, @HerzogenburgInvA, @HerzogenburgInvB, @Hornbacher2023, @KlosterneuburgInvA, @KlosterneuburgInvB, @KlosterneuburgInvE, @Radant1982, @Preisl2022, @Schmid1901, and @Tichy2019
...
- references: @Ball1900, @Bartos2013, @Bartos2018, @Brown1996, @BrtniceInv, @Eybl2011, @Freeman1992, @Haberkamp1986, @MacIntyre1984, @Oppova2013, @RajhradInvA, @RajhradInvB, @Rampackova2009, @Sanders1973, @Schroeder1991, @Slavicky2004, @Strakova1963, @Strakova1965, @Tichy2014, and @Tichy2014b
- sources:
...
- references: @Haberkamp1993, @Harich1975, @Kiesewetter1847, @Mitterschiffthaler1979, @Opatrny2012, @Sherman2001, @Stefan1985, and @StPeterInv
